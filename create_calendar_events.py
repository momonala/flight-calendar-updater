    ...
    for i, row in enumerate(rows):
        ...
        new_row = OrderedDict(
            [
                ...
                ("Departure Time", flight_info.format_time_with_offset(flight_info.departure_time)),
                ("Arrival Time", flight_info.format_time_with_offset(flight_info.arrival_time)),
